...
def upgrade():
    ...
    op.create_index(op.f('ix_history_phone_id'), 'history', ['phone_id'])
    op.drop_index('first_index', table_name='history')
    op.create_index(op.f('ix_history_backup_phone_id'), 'history_backup', ['phone_id'])
    op.drop_index('first_index', table_name='history_backup')
    op.create_index(op.f('ix_history_test_phone_id'), 'history_test', ['phone_id'])
